 ...
 * cooperativo, encaminhado ao statement JDBC quando suportado"). {@code execution.domain.job} owns
 * the real implementation ({@code CancellationToken}) and its coupling to a live JDBC
