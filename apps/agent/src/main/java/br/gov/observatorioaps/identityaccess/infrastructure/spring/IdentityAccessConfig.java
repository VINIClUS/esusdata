package br.gov.observatorioaps.identityaccess.infrastructure.spring;

import br.gov.observatorioaps.identityaccess.infrastructure.jdbc.JdbcAuthAuditWriter;
