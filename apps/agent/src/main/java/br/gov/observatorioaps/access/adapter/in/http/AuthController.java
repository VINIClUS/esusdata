...
import br.gov.observatorioaps.access.domain.AuthenticationFailedException;
...
import br.gov.observatorioaps.access.adapter.in.http.security.NoStoreCacheControlFilter;
...
public class AuthController {
    ...
    public ResponseEntity<Void> logout(
            @AuthenticationPrincipal br.gov.observatorioaps.access.domain.AuthenticatedSession session,
