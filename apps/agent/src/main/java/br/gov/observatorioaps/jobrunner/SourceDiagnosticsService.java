 ...
 * br.gov.observatorioaps.sourceconnector.PecSecretResolver} — this class only ever sees the
 * connection outcome.
 *
 * <p>Reuses {@link br.gov.observatorioaps.sourceconnector.SourceAcquisitionLimiter}'s one-active-
