package br.gov.observatorioaps.results.adapter.in.http;
...
import br.gov.observatorioaps.results.domain.EvidencePage;
import br.gov.observatorioaps.results.domain.EvidenceRepository;
import br.gov.observatorioaps.results.domain.EvidenceRecord;
import br.gov.observatorioaps.results.domain.PublishedResult;
...
import br.gov.observatorioaps.access.adapter.in.http.ScopeResponse;
 ...
 * only {@code results.domain} — navigating the panel never consults the PEC or recalculates (L306).
 */
@RestController
