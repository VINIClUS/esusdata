 ...
 * br.gov.observatorioaps.sourceconnector.domain.PecSecretResolver} — this class only ever sees the
 * connection outcome.
 *
 * <p>Reuses {@link br.gov.observatorioaps.sourceconnector.domain.SourceAcquisitionLimiter}'s one-active-
