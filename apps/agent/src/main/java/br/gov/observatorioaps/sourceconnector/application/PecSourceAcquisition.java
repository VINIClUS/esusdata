 ...
 */
public final class PecSourceAcquisition {
    ...
    static PecSourceAcquisition forTest(
            PecSourceConnection sourceConnection,
            LocalDate periodStart,
            LocalDate periodEndExclusive,
            BudgetGuard budgetGuard) {
        return new PecSourceAcquisition(sourceConnection, periodStart, periodEndExclusive, budgetGuard);
    }
