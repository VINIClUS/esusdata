 ...
 * free (no {@code jakarta.servlet} import anywhere in this package) — {@code
 * access.adapter.in.http.AuthController} translates the raw token this returns into a cookie,
 * and a request into {@code origin}/{@code now}.
 */
