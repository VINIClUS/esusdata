...
public final class IndividualEncounterModalityCapability {
    ...
    public static final String CAPABILITY = IndividualEncounterModalityContract.CAPABILITY;
    public static final String ADAPTER_VERSION = IndividualEncounterModalityContract.ADAPTER_VERSION;
    public static final String QUERY = IndividualEncounterModalityContract.QUERY;
    public static final String QUERY_CHECKSUM = IndividualEncounterModalityContract.QUERY_CHECKSUM;
