package br.gov.observatorioaps.testsupport;
...
import br.gov.observatorioaps.access.adapter.in.http.AuthRoundTripTest;
import br.gov.observatorioaps.access.application.ApiAuthorization;
import br.gov.observatorioaps.access.adapter.in.http.security.CsrfAndOriginTest;
import br.gov.observatorioaps.access.adapter.in.http.security.SessionCookie;
...
public abstract class ApiFixtureSupport extends SecuritySliceTestSupport {
    ...
    public String publishResult(
        ...
        resultStagingArea.open(new br.gov.observatorioaps.results.domain.StagingRequest(
